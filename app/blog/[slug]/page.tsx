              ...
              <aside className="lg:col-span-4 mt-12 lg:mt-0">
                <div className="sticky top-28 space-y-8">
                  ...
                  <div className="bg-teal-50 p-6 rounded-xl border border-teal-100 text-center">
                    ...
                    <a href="tel:+917582865931" className="mt-5 inline-flex w-full items-center justify-center bg-[#007B8A] text-white px-4 py-2.5 rounded-lg font-semibold hover:bg-teal-800 transition-colors shadow-sm">
